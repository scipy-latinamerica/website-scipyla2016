...
urlpatterns = patterns(
    ...
    url(r'^participate/tutorials/$',
        ...
        name='tutorials'),
    url(r'^participate/tutorials/tut0/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut0.html'},
        name='tut0'),
    url(r'^participate/tutorials/tut1/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut1.html'},
        name='tut1'),
    url(r'^participate/tutorials/tut2/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut2.html'},
        name='tut2'),
    url(r'^participate/tutorials/tut3/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut3.html'},
        name='tut3'),
    url(r'^participate/tutorials/tut4/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut4.html'},
        name='tut4'),
    url(r'^participate/tutorials/tut5/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut5.html'},
        name='tut5'),
    url(r'^participate/tutorials/tut6/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut6.html'},
        name='tut6'),
    url(r'^participate/tutorials/tut7/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut7.html'},
        name='tut7'),
    url(r'^participate/tutorials/tut8/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut8.html'},
        name='tut8'),
    url(r'^participate/tutorials/tut9/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut9.html'},
        name='tut9'),
    url(r'^participate/tutorials/tut10/$',
        direct_to_template,
        {'template': 'participate/tutorials/tut10.html'},
        name='tut10'),
    ...
    url(r'^participate/sprints/$',
        ...
        name='sprints'),
    url(r'^participate/registration/$',
        direct_to_template,
        {'template': 'participate/registration.html'},
        name="registration"),
